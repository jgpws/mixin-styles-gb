...
(() => {
/*!*********************************************************!*\
  !*** ./resources/js/mixin-styles-gb-editor-contrast.js ***!
  \*********************************************************/
...
(function () {
  ...
  function editorContrastLogic(element, options = {
    target: "both"
  }) {
      ...
      const updateBodyContrast = () => {
        ...
        if (iframeBody && editorContrastLogic) {
          ...
          if (currentColor !== lastColor) {
            ...
            editorContrastLogic(iframeBody, {
              target: "body"
            });
          }
        }
  ...
  const updateStyleBookContrast = iframe => {
    const injectWithRetry = (attempts = 0) => {
      ...
      if (styleBookDoc && styleBookDoc.body && styleBookDoc.body.innerHTML.trim() !== "" && editorContrastLogic) {
        ...
        editorContrastLogic(styleBookDoc.body, {
          target: "body"
        });
      } else if (attempts < 20) {
      ...
      useEffect(() => {
        ...
        if (blockElement) {
          ...
          requestAnimationFrame(() => {
            ...
            requestAnimationFrame(() => {
              const appliedToBlocks = editorContrastLogic(blockElement, {
                target: "block"
              });
...
/******/ })()
;
//# sourceMappingURL=mixin-styles-gb-editor-contrast.js.map