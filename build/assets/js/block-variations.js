/******/ (() => { // webpackBootstrap
/*!******************************************!*\
  !*** ./resources/js/block-variations.js ***!
  \******************************************/
wp.domReady(() => {
  ...
  const contentSidebarIcon = wp.element.createElement(wp.primitives.SVG, {
  ...
  const sidebarContentIcon = wp.element.createElement(wp.primitives.SVG, {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 24 24"
  }, wp.element.createElement(wp.primitives.Path, {
  ...
  const columnsIcon = wp.element.createElement(wp.primitives.SVG, {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 24 24"
  }, wp.element.createElement(wp.primitives.Path, {
