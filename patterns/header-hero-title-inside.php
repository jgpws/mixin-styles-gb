...
<div class="wp-block-group is-style-default header-hero-title-inside">
	<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'build/assets/images/bg_concircles_rby.png' ) ); ?>","id":11904,"isRepeated":true,"dimRatio":70,"overlayColor":"accent-3","contentPosition":"top center","isDark":false,"align":"full","className":"is-style-rounded-full"} -->
	<div class="wp-block-cover alignfull is-light is-repeated has-custom-content-position is-position-top-center is-style-rounded-full" style="background-image:url(<?php echo esc_url( get_theme_file_uri( 'build/assets/images/bg_concircles_rby.png' ) ); ?>)">
